                ...
                <div className="flex h-1/2 w-1/2 flex-col items-center justify-center gap-2 bg-white/20 shadow-md backdrop-blur-lg">
                    ...
                    <form className="my-6 grid gap-2 p-4" onSubmit={handleSubmit}>
                        ...
                        <input
                            ...
                            className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-400 dark:bg-gray-50 dark:text-black dark:placeholder-gray-400 dark:focus:border-blue-200 dark:focus:ring-blue-500"
                        />
