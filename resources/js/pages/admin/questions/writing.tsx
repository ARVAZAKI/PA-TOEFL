                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Manage passages and questions for {section} section
                        </p>
                    </div>
            ...
            <Dialog open={openPassageDialog} onOpenChange={setOpenPassageDialog}>
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {editingPassage ? 'Update passage information' : 'Add a new reading passage'}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Textarea
                                id="content"
                                value={passageForm.data.content}
                                onChange={(e) => passageForm.setData('content', e.target.value)}
