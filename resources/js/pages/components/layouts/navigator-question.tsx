...
export default function NavigatorBox({ propsNav }: NavigatorBoxProps) {
    ...
    return (
        <div className="w-full space-y-2 rounded-lg border bg-white p-3 shadow-sm lg:w-60 lg:space-y-4 lg:p-4">
            <div className="flex items-center justify-between lg:block">
                <div className="text-sm font-medium">{username}</div>
                <div className="text-xs text-gray-500">{sectionActive} navigator</div>
            </div>

            <div className="flex flex-wrap gap-1.5 text-sm lg:grid lg:grid-cols-5 lg:gap-2">
